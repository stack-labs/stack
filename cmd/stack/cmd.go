// Package stackCmd is an interface for parsing the command line
package stack
...
type Cmd interface {
	// The cli app within this stackCmd
	App() *cli.App
	// Adds options, parses flags and initialise
	// exits on error
	Init(opts ...cmd.Option) error
...
func newCmd(opts ...cmd.Option) Cmd {
	options := cmd.Options{}
...
func (c *stackCmd) beforeLoadConfig(ctx *cli.Context) (err error) {
...
func (c *stackCmd) beforeSetupOptions() (err error) {
...
func (c *stackCmd) Options() cmd.Options {
	return c.opts
}

func (c *stackCmd) Init(opts ...cmd.Option) error {
	for _, o := range opts {
		o(&c.opts)
	}
